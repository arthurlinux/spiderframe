...
class AdminFunctions extends Functions
{
    public static function __getUserList(DbConnection $DbConnection = null) 
	{
		$DbConnection = ($DbConnection == null) ? DbConnection::getInstance("_root") : $DbConnection ;
	  	...
	  	$sql = "SELECT 
				...
				AND
					cat_user_rol.rol = 'user'
				AND
					cat_user_x_rol.active = '1' 
				AND
	...
	public static function __getMemberList(DbConnection $DbConnection = null) 
	{
		$DbConnection = ($DbConnection == null) ? DbConnection::getInstance("_root") : $DbConnection ;
	  	...
	  	$sql = "SELECT 
			 		...
			 		user_login.active
				FROM 
					user_login, user, user_account, cat_user_rol, cat_user_x_rol 
				WHERE 
					cat_user_x_rol.user_id = user.user_id
				AND
