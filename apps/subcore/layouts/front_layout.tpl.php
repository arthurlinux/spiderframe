...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
 	<head>
		...
		<link rel="shortcut icon" 	type="image/x-gif" href="<?php echo TO_ROOT ?>/apps/subcore/style/images/favicon.png" />
		<link rel="stylesheet" 		type="text/css" media="screen" charset="utf-8" href="<?php echo TO_ROOT ?>/apps/subcore/style/front.css" />
		<link rel="stylesheet" 		type="text/css" media="screen" charset="utf-8" href="<?php echo TO_ROOT ?>/apps/subcore/style/overlay.css" />
		<link rel="stylesheet" 		type="text/css" media="screen" charset="utf-8" href="<?php echo TO_ROOT ?>/apps/subcore/style/jquery.ui/<?php echo $__jquery_theme ?>/jquery-ui.css" />
		...
		<script src="<?php echo TO_ROOT ?>/apps/subcore/scripts/script.core.js" 	type="text/javascript"></script>
		<script src="<?php echo TO_ROOT ?>/apps/subcore/scripts/script.extend.js" 	type="text/javascript"></script>
		<script src="<?php echo TO_ROOT ?>/apps/subcore/scripts/script.essentials.js" 	type="text/javascript"></script>
				...
				<div id="info"> 
					...
					<div id="secondary_nav">
						<?php if ($_SESSION["user_login_id"]) { ?>
							<a id="link_login" href="<?php echo TO_ROOT ?>/apps/subcore/functions/logout.php"><?php echo Functions::__Translate("Logout") ?></a>
						<?php } else { ?>
