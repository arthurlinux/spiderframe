...
{   //alert(__isArray(params));
	...
	{
		temp_params = params;
		params = {"message":"<image id='__loader' src='../apps/subcore/style/images/loading_bubble.gif'>", "buttons": false,"level":false}
	}
...
function __showLoader(message,loader) 
{
	...
	var loaderImage = (!loader || loader == "loading" ) ? "<image id='__loader' src='../apps/subcore/style/images/loading_bubble.gif'> " : "<image src='../core/styles/images/loading_bar.gif' > " ;
...
{	
	var src = "../../apps/subcore/style/images/close.png";
...
function __loadDictionaryInStorage(page)
{
	...
	if(!dictionary)
	{
		dictionary =  __sendRequest ({"url":"../subcore/application/get_dictionary.php","dataForm":"page="+page});
	}
...
{ 
	$("#" + state_id).change(function(){
		...
		var cities = __sendRequest({"url":"../subcore/application/get_cities.php", "dataForm": dataForm, "type": "GET"});
...
{
	//var items = __createOptionForComboBox(items, selected);
	//var select = "<select" + parameters ">\n" + items + "</select>\n";
...
{	
	...
	//$("#" + id).append("<option>hola</option>"); alert(items);
